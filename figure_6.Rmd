...
grp_to_shape <- setNames(
  rep(age_to_shape[1:2], each = 2)
  ,
  c(
    "no bcg",
    "bcg", 
...
p_legend <- ggplot() + 
  ...
  scale_shape_manual(
    values = grp_or_var_exp_to_shape
  ) +
  scale_fill_manual(
...
path_fig <- file.path(dir_fig_manu, "fig_6.pdf")
cowplot::ggsave2(
  path_fig, 
  p_test_full, 
  height = 29.4, 
